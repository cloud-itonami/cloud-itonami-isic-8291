# Operator Quickstart — cloud-itonami-isic-8291

Shortest path from clone to a verified local dry-run for **ISIC 8291** (`cloud-itonami-isic-8291`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8291.git
